...
echo "OOPS Summary: (always the occurrences amount and then the description; if they are empty, then either there are no pitfalls relevant or the file has syntax issues) <br> Critical: <br> " `cat critical.txt` " <br>  <br> Important: <br> " `cat important.txt` " <br>  <br> Minor: <br> " `cat minor.txt` " <br>  <br> " > reports.txt
echo "RDFUnit Summary: (always the occurrences amount and then the description)<br>" >> reports.txt
